...
(async function() {
    ...
    btnSearch.addEventListener("click", (e)=>{
        ...
        const otherSolutions = [
            ...results
        ].splice(1, 5).reduce((allSolutions, solution)=>allSolutions + `<li>${solution}</li>`, "");
...
parcelHelpers.export(exports, "findLongestWord", ()=>findLongestWord);
parcelHelpers.export(exports, "getDictionary", ()=>getDictionary);
parcelHelpers.export(exports, "getChars", ()=>getChars);
parcelHelpers.export(exports, "generateRandomChar", ()=>generateRandomChar);
parcelHelpers.export(exports, "getLastInputElementIndex", ()=>getLastInputElementIndex);
const findLongestWord = (dictionary, randomStr)=>{
    ...
    const charactersMap = randomStr.toLowerCase().split("").reduce((allCharacters, currentCharacter)=>{
...
const getChars = (obj)=>{
    return [
        ...obj
    ].reduce((acc, curr)=>curr.value ? acc + curr.value : acc, "");
};
...
},{}]},["lKzq4","bNKaB"], "bNKaB", "parcelRequired821")
